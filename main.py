...
В этой версии присутствует основная игровая функция.
Это при помощи кнопки "score + 1" увеличивать свой счет.
При достижении определенного значения Score есть возможность купить улучшения (1st и 2nd upgrade).
Они увеличивают количество очков, которое получает игрок при нажатии на кнопку "Score + ..."
Это значение указано на самой кнопке. 
Изначально там указано 1, а после покупки улучшений оно будет меняться.
